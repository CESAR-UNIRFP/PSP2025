...
public class ClienteMusicaRMI {
    public static void main(String[] args) {
        ...
        try {
            ...
            registry = LocateRegistry.getRegistry("192.168.1.68", 5055);
            ...
            do {
                ...
                switch (opcion) {
                    case "T":
                        ...
                        break;
                    case "B":
                        System.out.println("Escribe nombre de la banda: ");
                        buscado = lector.nextLine();
    ...
    private static void escribirMenu() {
        ...
        System.out.println("--------------------------");
        System.out.println("T = Título Musica");
        System.out.println("B = Titulo Pelis");
